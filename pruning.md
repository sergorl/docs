...
**???** Алгоритм **pruning**'a находится в [423-459](https://github.com/beam-mw/grin/blob/master/core/src/core/pmmr.rs) строчках. В данном алгоритме сохранются только начальный узел и пики, которые помещаются в некоторый remove_list структуры, реализующей trait Backend.
